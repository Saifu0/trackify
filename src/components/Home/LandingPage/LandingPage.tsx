...
<img style={{height: "60%",width: "92%",paddingTop: "3em",borderRadius: "1em"}} src={frame1} alt="landingimage"></img>
</Col>
</Row>

<Row style={{display: "flex",justifyContent: "center",height: "100vh",width: "100vw"}}>
<Col style={{display: "flex",justifyContent: "center",alignItems: "center"}} span={12} sm={24} xs={24}lg={12}>
<img style={{height: "55%",width: "92%",paddingTop: "3em",borderRadius: "1em"}} src={frame2} alt="landingimage"></img>
</Col>
